...
module.exports ={
    ...
    execute(client, message, args){
        ...
        .addFields(
            {name:"`p!about`", value:"View a message from Pepi about the server"},
            ...
            {name:"`p!help`", value:"See a list of all commands"},
            ...
            {name:"`p!guess`", value:"Play a game of Akinator with the bot"},
            {name:"`p!rps <rock|paper|scissors>`", value:"Play a game of Rock, Paper, Scissors with the bot"},
        )
        .setTimestamp()
