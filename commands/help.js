...
module.exports ={
    ...
    execute(message, args){
        ...
        .addFields(
            {name:"`p!about`", value:"Information about this origins of this server"},
            {name:"`p!appeals`", value:'Some basic information on how to appeal a ban'},
            {name:"`p!commands`", value:"Get a list of useful ingame commands for The PepiOnLine SMP"},
            {name:"`p!economy`", value:"You can see some prices for the ingame sellable items"},
