...
module.exports ={
    ...
    execute(message,args){
        ...
        .setDescription('If you happen to be a victim of griefing, you can open a ticket by going to <#929088852734394388> and clicking the button on the message provided. This will let you speak with a Staff member directly.')
        .setTimestamp()
