...
module.exports = {
    ...
    execute(client, message, args) {
        ...
        const claimed_weekly_embed = new EmbedBuilder()
            .setColor("#FF0000")
            .setDescription(`You have already claimed your reward for this week! Time left until next bonus: **${weekly.value.days}** days, **${weekly.value.hours}** hours, **${weekly.value.minutes}** minutes and **${weekly.value.seconds}** seconds.`)
            .setTimestamp();
